...
case 0x30:
	// SWAP B
	BC.B.B1 = ((BC.B.B1 & 0xf0) >> 4 | (BC.B.B1 & 0x0f) << 4) & 0xFF;
	AF.B.B0 = ZeroTable[BC.B.B1];
	break;
case 0x31:
	// SWAP C
	BC.B.B0 = ((BC.B.B0 & 0xf0) >> 4 | (BC.B.B0 & 0x0f) << 4) & 0xFF;
	AF.B.B0 = ZeroTable[BC.B.B0];
	break;
case 0x32:
	// SWAP D
	DE.B.B1 = ((DE.B.B1 & 0xf0) >> 4 | (DE.B.B1 & 0x0f) << 4) & 0xFF;
	AF.B.B0 = ZeroTable[DE.B.B1];
	break;
case 0x33:
	// SWAP E
	DE.B.B0 = ((DE.B.B0 & 0xf0) >> 4 | (DE.B.B0 & 0x0f) << 4) & 0xFF;
	AF.B.B0 = ZeroTable[DE.B.B0];
	break;
case 0x34:
	// SWAP H
	HL.B.B1 = ((HL.B.B1 & 0xf0) >> 4 | (HL.B.B1 & 0x0f) << 4) & 0xFF;
	AF.B.B0 = ZeroTable[HL.B.B1];
	break;
case 0x35:
	// SWAP L
	HL.B.B0 = ((HL.B.B0 & 0xf0) >> 4 | (HL.B.B0 & 0x0f) << 4) & 0xFF;
	AF.B.B0 = ZeroTable[HL.B.B0];
	break;
case 0x36:
	// SWAP (HL)
	tempValue = gbReadMemory(HL.W);
	tempValue = ((tempValue & 0xf0) >> 4 | (tempValue & 0x0f) << 4) & 0xFF;
	AF.B.B0	  = ZeroTable[tempValue];
	gbWriteMemory(HL.W, tempValue);
	break;
case 0x37:
	// SWAP A
	AF.B.B1 = ((AF.B.B1 & 0xf0) >> 4 | (AF.B.B1 & 0x0f) << 4) & 0xFF;
	AF.B.B0 = ZeroTable[AF.B.B1];
	break;
case 0x38:
	// SRL B
