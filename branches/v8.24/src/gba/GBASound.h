...
extern void soundEnableChannels(int);
extern void soundDisableChannels(int);
extern int  soundGetEnabledChannels();
#if 0
extern void soundMuteChannels(int);
extern void soundUnmuteChannels(int);
extern int  soundGetMutedChannels();
#endif
