...
#if 0
	resChannels = regQueryDwordValue("soundMute", 0);
	soundMuteChannels(resChannels);
	soundUnmuteChannels(~resChannels);
#endif
...
#if 0
	regSetDwordValue("soundMute", soundGetMutedChannels() & 0x030f);
#endif
