...
class MainWnd : public CWnd
{
 ...
 protected:
  ...
  afx_msg void OnUpdateOptionsFrameskipThrottle37(CCmdUI* pCmdUI);
  ...
  afx_msg void OnUpdateOptionsFrameskipThrottle87(CCmdUI* pCmdUI);
  afx_msg void OnUpdateOptionsFrameskipThrottle100(CCmdUI* pCmdUI);
  afx_msg void OnUpdateOptionsFrameskipThrottle112(CCmdUI* pCmdUI);
  ...
  afx_msg void OnOptionsFrameskipThrottle37();
  afx_msg void OnOptionsFrameskipThrottle50();
  afx_msg void OnOptionsFrameskipThrottle75();
  afx_msg void OnOptionsFrameskipThrottle87();
  afx_msg void OnOptionsFrameskipThrottle100();
  afx_msg void OnOptionsFrameskipThrottle112();
  ...
  afx_msg void OnToolsPlayContinue();
  afx_msg void OnUpdateToolsPlayContinue(CCmdUI* pCmdUI);
