...
struct {
  ...
  { "OpenRom(!)", ID_FILE_OPEN }, // a (!) puts it in the "common hotkeys" list
  { "Load from file...", ID_FILE_LOAD },
  { "Save to file...", ID_FILE_SAVE },
  ...
  { "VideoRenderSelectSkin", ID_OPTIONS_VIDEO_RENDEROPTIONS_SELECTSKIN },
  { "VideoRenderSkin", ID_OPTIONS_VIDEO_RENDEROPTIONS_SKIN },
  { "VideoVsync", ID_OPTIONS_VIDEO_VSYNC },
  ...
  { "EmulatorSelectBIOS", ID_OPTIONS_EMULATOR_SELECTBIOSFILE },
  { "EmulatorUseBIOS", ID_OPTIONS_EMULATOR_USEBIOSFILE },
  { "EmulatorUseOldGBTiming", ID_EMULATOR_USEOLDGBTIMING },
  { "EmulatorGBALagging", ID_EMULATOR_GBALAG },
  { "EmulatorSkipBIOS", ID_OPTIONS_EMULATOR_SKIPBIOS },
  { "EmulatorShowSpeedNone", ID_OPTIONS_EMULATOR_SHOWSPEED_NONE },
  { "EmulatorShowSpeedPercentage", ID_OPTIONS_EMULATOR_SHOWSPEED_PERCENTAGE },
  { "EmulatorShowSpeedDetailed", ID_OPTIONS_EMULATOR_SHOWSPEED_DETAILED },
  ...
  { "EmulatorRemoveIntros", ID_OPTIONS_EMULATOR_REMOVEINTROSGBA },
  { "EmulatorAutoHideMenu", ID_OPTIONS_EMULATOR_AUTOHIDEMENU },
  { "EmulatorSaveAuto", ID_OPTIONS_EMULATOR_SAVETYPE_AUTOMATIC },
  { "EmulatorSaveEEPROM", ID_OPTIONS_EMULATOR_SAVETYPE_EEPROM },
  { "EmulatorSaveSRAM", ID_OPTIONS_EMULATOR_SAVETYPE_SRAM },
  { "EmulatorSaveFLASH", ID_OPTIONS_EMULATOR_SAVETYPE_FLASH },
  { "EmulatorSaveEEPROMSensor", ID_OPTIONS_EMULATOR_SAVETYPE_EEPROMSENSOR },
  { "EmulatorSaveFlash64K", ID_OPTIONS_EMULATOR_SAVETYPE_FLASH512K },
  { "EmulatorSaveFlash128K", ID_OPTIONS_EMULATOR_SAVETYPE_FLASH1M },
  { "EmulatorAutoIPSPatch", ID_OPTIONS_EMULATOR_AUTOMATICALLYIPSPATCH },
  { "EmulatorAGBPrint", ID_OPTIONS_EMULATOR_AGBPRINT },
  { "EmulatorRTC", ID_OPTIONS_EMULATOR_REALTIMECLOCK },
  { "EmulatorRewindSettings", ID_OPTIONS_EMULATOR_REWINDINTERVAL },
  ...
  { "SoundStartRecording", ID_OPTIONS_SOUND_STARTRECORDING },
  { "SoundStopRecording", ID_OPTIONS_SOUND_STOPRECORDING },
  { "AVIStartRecording", ID_TOOLS_RECORD_STARTAVIRECORDING },
  { "AVIStopRecording", ID_TOOLS_RECORD_STOPAVIRECORDING },
  { "RecordMovieStart", ID_TOOLS_RECORD_STARTMOVIERECORDING },
  { "RecordMovieStop", ID_TOOLS_RECORD_STOPMOVIERECORDING },
  { "PlayMovieStart", ID_TOOLS_PLAY_STARTMOVIEPLAYING },
  { "PlayMovieStop", ID_TOOLS_PLAY_STOPMOVIEPLAYING },
  { "MovieReadOnly(!)", ID_TOOLS_PLAY_READONLY},
  { "MovieContinueRecording", ID_TOOLS_PLAY_CONTINUE},
  { "MoviePlayFromBeginning", ID_TOOLS_PLAY_RESTART},
