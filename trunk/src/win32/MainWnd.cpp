...
ON_COMMAND(ID_TOOLS_VBAWATCH_SETTING, OnToolsCopyVBAWatchSetting)
ON_COMMAND(ID_TOOLS_VBXWATCH_SETTING, OnToolsCopyVBxWatchSetting)
...
ON_COMMAND_EX_RANGE(ID_OPTIONS_FILTER16BIT_SIMPLE3X, ID_OPTIONS_FILTER16BIT_SIMPLE4X, OnOptionsFilter)
...
ON_UPDATE_COMMAND_UI_RANGE(ID_OPTIONS_FILTER16BIT_SIMPLE3X, ID_OPTIONS_FILTER16BIT_SIMPLE4X, OnUpdateOptionsFilter)
