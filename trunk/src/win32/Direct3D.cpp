	...
	if(textMethod == 2)
	{
		for(int slot = 0 ; slot < SCREEN_MESSAGE_SLOTS ; slot++)
		{
			if(theApp.screenMessage[slot]) {
				...
				switch(textColor)
				{
					case 0: color = D3DCOLOR_ARGB(255, 255, 255, 255); break;
					case 1: color = D3DCOLOR_ARGB(255, 255, 0, 0); break;
					case 2: color = D3DCOLOR_ARGB(255, 255, 255, 0); break;
					case 3: color = D3DCOLOR_ARGB(255, 0, 255, 0); break;
					case 4: color = D3DCOLOR_ARGB(255, 0, 255, 255); break;
					case 5: color = D3DCOLOR_ARGB(255, 0, 0, 255); break;
					case 6: color = D3DCOLOR_ARGB(255, 255, 0, 255); break;
					case 7: color = D3DCOLOR_ARGB(255, 0, 0, 0); break;
				}
